...
class EfficientNet(pl.LightningModule):
    def __init__(self, model_name='tf_efficientnet_b4_ns', dropout=0.1):
        ...
        self.backbone.classifier = nn.Linear(n_features, 2)
        self.backbone = torch.nn.DataParallel(self.backbone)
        self.backbone.load_state_dict(torch.load('/d/hpc/projects/FRI/ldragar/tf_efficientnet_b4_ns.pth'))
...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project='luka_borut', name='tf_efficientnet_b4_ns', save_dir='/d/hpc/projects/FRI/ldragar/wandb/')


    #convnext_xlarge_384_in22ft1k
    model=EfficientNet(model_name='tf_efficientnet_b4_ns', dropout=0.1)
    ...
    checkpoint_callback = ModelCheckpoint(monitor='val_loss', 
                                        ...
                                        filename='tf_efficientnet_b4_ns-{epoch:02d}-{val_loss:.2f}', mode='min', save_top_k=1)
