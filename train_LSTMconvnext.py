...
import os
from dataset_1 import FaceFramesDataset, FaceFramesPredictionDataset, RandomFaceFramesDataset, VideoFramesDataset
...
class ConvNeXt(pl.LightningModule):
    def __init__(self, model_name='convnext_tiny', dropout=0.1, lstm_hidden_size=512, num_layers=1):
        ...
        output_dim = 16  # You can adjust this value to control the amount of information passed to the LSTM
        ...
        self.lstm = nn.LSTM(output_dim, lstm_hidden_size, num_layers, batch_first=True)
    ...
    def forward(self, x):
        ...
        _, (h_n, _) = self.lstm(x)  # h_n has shape (num_layers, batch_size, lstm_hidden_size)
...
if __name__ == '__main__':
    ...
    vid_dataset =VideoFramesDataset(dataset_root, labels_file,transform=transform_train,sequence_length=seq_len)
    ...
    wandb_logger = WandbLogger(project='luka_borut', name='LSTMconvnext_xlarge_384_in22ft1k', save_dir='/d/hpc/projects/FRI/ldragar/wandb/')
