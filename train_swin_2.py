...
import os
from dataset_1 import FaceFramesDataset, FaceFramesPredictionDataset
...
class Swin(pl.LightningModule):
    def __init__(self, model_name='swin_large_patch4_window12_384_in22k', dropout=0.1):
        ...
        #self.backbone.load_state_dict(torch.load('/d/hpc/projects/FRI/ldragar/swin_large_patch4_window12_384_in22k_40.pth'))
...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(project='luka_borut', name='swin_large_patch4_window12_384_in22k_40', save_dir='/d/hpc/projects/FRI/ldragar/wandb/')


    #convnext_xlarge_384_in22ft1k
    model=Swin(model_name='swin_large_patch4_window12_384_in22k', dropout=0.1)  
    ...
    checkpoint_callback = ModelCheckpoint(monitor='val_loss', 
                                        ...
                                        filename='swin_large_patch4_window12_384_in22k-{epoch:02d}-{val_loss:.2f}', mode='min', save_top_k=1)
