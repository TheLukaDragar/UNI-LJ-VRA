...
srun --nodes=1 --exclusive --gpus=1 --ntasks-per-node=1 --time=0-3:00:00 -p gpu python search_predict_convnext.py --seed $seed --out_predictions_dir $out_predictions_dir --cp_id $cp_id --x_predictions 1
