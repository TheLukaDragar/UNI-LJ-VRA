...
from dataset_1 import  VideoFramesDataset_3_face, VideoFramesPredictionDataset_3
...
if __name__ == '__main__':
    ...
    face_frames_dataset =VideoFramesDataset_3_face(dataset_root, labels_file,transform=transform_train,sequence_length=seq_len)
    ...
    wandb_logger = WandbLogger(project='luka_borut', name='TIMESeqencedconvnext_xlarge_384_in22ft1k', save_dir='/d/hpc/projects/FRI/ldragar/wandb/')
    ...
    if trainer.global_rank == 0:
        ...
        for stage in stages:
            ...
            ds = VideoFramesPredictionDataset_3(labels_file=os.path.join(test_labels_dir, name), dataset_root=dataset_root,transform=transform_test)
